...
if($ptype==''):
	...
	echo $ptype;
            ...
            <!-- Your previous code for displaying booking details -->
...
<table class="table table-hover table-bordered">
    ...
    <?php
    $gpayment = 0; // Initialize total payment
    ...
    <?php
        $gpayment += $result->payment; // Calculate total payment
    }
    ?>
    <tr>
        <th>Total</th>
...
<?php
    ...
    echo "No payment records found for bookingID: $bookindid";
}
?>
